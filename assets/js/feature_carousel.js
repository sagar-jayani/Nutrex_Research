...
(function($) {
    ...
    $.fn.featureCarousel = function (options) {
      ...
      var animateFeature = function($feature, direction)
      {
        ...
        if (newPosition == 1) {
          var current_feature = $($feature).attr('data-imgindex');
          $('.home_range_content .cm_home_range').removeClass('content-active');
          document.querySelector('.home_range_content .cm_home_range[data-contentindex="'+current_feature+'"]').classList.add('content-active');
